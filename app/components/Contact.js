        ...
        return (
            ...
            <Card>
              ...
              <Image source={require("../assets/images/rmutl.png")}
                 style={{resizeMode:'contain', width:width ,height:200 ,alignSelf:"center"}}/>
                </Row>
                <Row size={70}>
                <CardItem bordered style={{padding:5 , width:width}}>
                <Body >
                <Text style={{paddingTop:10}}>ที่อยู่ : 98 หมู่ 8 ตำบลป่าป้อง อำเภอดอยสะเก็ด จังหวัดเชียงใหม่ 50220</Text>
